function [ImgR_back, ImgG_back, ImgB_back, Dye01_transmittance, Dye02_transmittance, Dye03_transmittance, LUTdye01, LUTdye02, LUTdye03, Q3x3Mat] = Colour_Deconvolution2(ImgR, ImgG, ImgB, StainingVectorID, DyeToBeRemovedID, doIcross)
...
elseif (SMrow==1 && SMcol==1 && SMnch==1)
    if (StainingVectorID<1 || StainingVectorID>38)
...
elseif StainingVectorID==22
    % https://github.com/jnkather/ColorDeconvolutionMatlab;
    MODx = [0.6500286, 0.704031, 0.2860126]; 
    MODy = [0.26814753, 0.57031375, 0.77642715];
    MODz = [0.7110272, 0.42318153, 0.5615672];

elseif StainingVectorID==23
    ...
    MODx = [0.65, 0.70, 0.29];
    MODy = [0.27, 0.57, 0.78];
    MODz = [0.07, 0.99, 0.11]; %Eosin

elseif StainingVectorID==24
    ...
    MODx = [0.18, 0.20, 0.08]; 
    MODy = [0.10, 0.21, 0.29];
    MODz = [0.01, 0.13, 0.01]; %Eosin

elseif StainingVectorID==25
    %  https://github.com/qupath/qupath/wiki/Preprocessing
    %  https://www.imagescientist.com/brightfield-color-deconvolution
    MODx = [0.651, 0.701, 0.290]; 
    MODy = [0.269, 0.568, 0.778];
    MODz = [0.633, -0.713, 0.302]; 
       
elseif StainingVectorID==26
    %  https://github.com/qupath/qupath/wiki/Preprocessing
    %  https://www.imagescientist.com/brightfield-color-deconvolution
    MODx = [0.712, 0.673, 0.201]; 
    MODy = [0.477, 0.669, 0.570];
    MODz = [0.583, -0.726, 0.364];
 
elseif StainingVectorID==27
    %  https://github.com/qupath/qupath/wiki/Preprocessing
    %  https://www.imagescientist.com/brightfield-color-deconvolution
    MODx = [0.701, 0.676, 0.230]; 
    MODy = [0.522, 0.700, 0.487];
    MODz = [0.542, -0.713, 0.444];
             
elseif StainingVectorID==28
    %  https://github.com/qupath/qupath/wiki/Preprocessing
    %  https://www.imagescientist.com/brightfield-color-deconvolution
    MODx = [0.661, 0.620, 0.423]; 
    MODy = [0.329, 0.646, 0.689];
    MODz = [0.369, -0.759, 0.536];
               
elseif StainingVectorID==29
    %  https://github.com/qupath/qupath/wiki/Preprocessing
    %  https://www.imagescientist.com/brightfield-color-deconvolution
    MODx = [0.641, 0.646, 0.416]; 
    MODy = [0.498, 0.616, 0.611];
    MODz = [0.572, -0.762, 0.302];
                 
elseif StainingVectorID==30
    %  https://github.com/qupath/qupath/wiki/Preprocessing
    %  https://www.imagescientist.com/brightfield-color-deconvolution
    MODx = [0.710, 0.661, 0.241]; 
    MODy = [0.456, 0.642, 0.617];
    MODz = [0.573, -0.742, 0.348];
                         
elseif StainingVectorID==31
    %  https://github.com/qupath/qupath/wiki/Preprocessing
    %  https://www.imagescientist.com/brightfield-color-deconvolution
    MODx = [0.737, 0.631, 0.241]; 
    MODy = [0.524, 0.636, 0.566];
    MODz = [0.535, -0.763, 0.362];

elseif StainingVectorID==32
    %  https://github.com/qupath/qupath/wiki/Preprocessing
    %  https://www.imagescientist.com/brightfield-color-deconvolution
    MODx = [0.725, 0.586, 0.363]; 
    MODy = [0.481, 0.622, 0.618];
    MODz = [0.391, -0.783, 0.484];

elseif StainingVectorID==33
    %  https://github.com/qupath/qupath/wiki/Preprocessing
    %  https://www.imagescientist.com/brightfield-color-deconvolution
    MODx = [0.741, 0.567, 0.360]; 
    MODy = [0.463, 0.626, 0.627];
    MODz = [0.340, -0.779, 0.527];

elseif StainingVectorID==34
    %  https://github.com/qupath/qupath/wiki/Preprocessing
    %  https://www.imagescientist.com/brightfield-color-deconvolution
    MODx = [0.715, 0.648, 0.264]; 
    MODy = [0.478, 0.623, 0.619];
    MODz = [0.567, -0.758, 0.324];

elseif StainingVectorID==35
    %  https://github.com/qupath/qupath/wiki/Preprocessing
    %  https://www.imagescientist.com/brightfield-color-deconvolution
    MODx = [0.759, 0.610,  0.229]; 
    MODy = [0.468, 0.636, 0.614];
    MODz = [0.488, -0.765, 0.420];  

elseif StainingVectorID==36
    %  https://github.com/qupath/qupath/wiki/Preprocessing
    %  https://www.imagescientist.com/brightfield-color-deconvolution
    MODx = [0.726, 0.661, 0.188]; 
    MODy = [0.482, 0.646, 0.591];
    MODz = [0.588, -0.740, 0.329];

elseif StainingVectorID==37
    %  https://github.com/qupath/qupath/wiki/Preprocessing
    %  https://www.imagescientist.com/brightfield-color-deconvolution
    MODx = [0.741, 0.606, 0.290]; 
    MODy = [0.445, 0.647, 0.619];
    MODz = [0.432, -0.761, 0.485]; 

elseif StainingVectorID==38
    % function Colour_Deconvolution2 from Fiji
    % https://github.com/landinig/IJ-Colour_Deconvolution2
    MODx = [1.20008420810656, -0.689387725766535, 0.636214232961718]; 
    MODy = [0.685203230666564, 0.0235969196559078, -0.710026796260320];
    MODz = [-0.917768568624354, 1.50870556052618, 0.301816829168353]; 
