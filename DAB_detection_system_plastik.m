function [cluster_DAB, j_DAB, image_new_a, DAB_area] = DAB_detection_system_plastik(image, gr_badawcza)
    ...
    % function to find areas of plastic
    ...
    [~, BBox, fill] = my_background_plastic(imageHDAB(:,:,1), 'a', plastic_det); % utworzenie maski z uwzględnieniem usuwania plastiku
